            ...
            <div class="text-article">
                <form method="POST" action="">
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <input type="number" name="idchoice" class="form-control" id="staticIdchoice" readonly value="${choicesDelete[0].getId()}"/>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <%--@declare id="questionid"--%><label for="questionid" class="col-sm-3 col-form-label">Вопрос</label>
                        <div class="col-sm-7">
                            <input type="number" name="questionid" class="form-control" id="staticQuestionid" readonly value="${choicesDelete[0].getQuestionId()}"/>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <%--@declare id="userid"--%><label for="userid" class="col-sm-3 col-form-label">Пользователь</label>
                        <div class="col-sm-7">
                            <input type="number" name="userid" class="form-control" id="staticUserid" readonly value="${choicesDelete[0].getUserId()}"/>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <%--@declare id="choiceuser"--%><label for="choiceuser" class="col-sm-3 col-form-label">Выбор пользователя</label>
                        <div class="col-sm-7">
                            <input type="number" name="choiceUser"  class="form-control" id="staticChoiceUser" readonly value="${choicesDelete[0].getChoiceUser()}"/>
                        </div>
                    </div>
                    <button type="submit"
