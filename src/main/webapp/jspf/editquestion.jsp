            ...
            <div class="text-article">
                <form method="post" action="">
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <input type="number" name="idquestion" class="form-control" id="staticIdquestion" readonly value="${questionsEdit[0].getId()}"/>
                        </div>
                    </div>
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="content" class="form-control" id="staticContent" value="${questionsEdit[0].getContent()}"/>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <%--@declare id="dateVote"--%><label for="dateVote" class="col-sm-3 col-form-label">Дата голосования</label>
                        <div class="col-sm-7">
                            <input type="date" name="dateVote" class="form-control" id="staticDatevote" value="${questionsEdit[0].getDateVote()}"/>
                        </div>
                    </div>
                    <button type="submit"
