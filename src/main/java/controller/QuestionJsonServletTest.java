...
@WebServlet(name = "QuestionJsonServletTest", value = "/questionsjsontest")
public class QuestionJsonServletTest extends HttpServlet {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                jsonArray.add(Json.createObjectBuilder()
                        .add("id", rs.getInt("id"))
                        .add("voteid", rs.getInt("voteId"))
                        .add("content", rs.getString("content"))
                        .add("dateVote", rs.getString("dateVote"))
                        .add("votetitle", FindById(id, votes).getTitle()));
            }
            stmt.close();
           ...
           // request.setAttribute("questionsjson", jsonArray.build());
            ...
            writer.print(jsonObject.add("questions", jsonArray).build());
