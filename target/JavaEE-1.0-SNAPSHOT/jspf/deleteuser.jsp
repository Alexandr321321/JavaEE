            ...
            <div class="text-article">
                <form method="post" action="">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="fio" class="form-control" id="staticFirstname" readonly value="${usersDelete[0].getFio()}"/>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <%--@declare id="password"--%><label for="password" class="col-sm-3 col-form-label">Пароль</label>
                        <div class="col-sm-7">
                            <input type="text" name="password" class="form-control" id="staticLastname" readonly value="${usersDelete[0].getPassword()}"/>
                        </div>
                    </div>
                    <div class="mb-3 row">
