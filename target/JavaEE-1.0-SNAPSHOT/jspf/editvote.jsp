...
<div id="main">
    <aside class="leftAside">
        <h3>Редактирование голосование</h3>
            ...
            <div class="text-article">
                <form method="post" action="">
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7">
                            <input type="number" name="idvote" class="form-control" id="staticIdvote" readonly value="${votesEdit[0].getId()}"/>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <%--@declare id="title"--%><label for="title" class="col-sm-3 col-form-label">Тайтл</label>
                        <div class="col-sm-7">
                            <input type="text" name="title" class="form-control" id="staticTitle" value="${votesEdit[0].getTitle()}"/>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <%--@declare id="dateStart"--%><label for="dateStart" class="col-sm-3 col-form-label">Дата начала</label>
                        <div class="col-sm-7">
                            <input type="date" name="dateStart" class="form-control" id="staticDateStart" value="${votesEdit[0].getDateStart()}"/>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <%--@declare id="dateFinish"--%><label for="dateFinish" class="col-sm-3 col-form-label">Дата окончания</label>
                        <div class="col-sm-7">
                            <input type="date" name="dateFinish" class="form-control" id="staticDateFinish" value="${votesEdit[0].getDateFinish()}"/>
                        </div>
                    </div>
                    <div class="mb-3 row">
